...
def sort_combined_half(lista):
    ...
    # Ordenar a primeira metade em ordem crescente
    primeira_metade_ordenada = counting_sort(primeira_metade)
    
    # Ordenar a segunda metade em ordem decrescente
    segunda_metade_ordenada = counting_sort(segunda_metade)[::-1]
...
# Exemplo de uso
lista = [12, 11, 22, 25, 90, 64, 34, 22]  # Primeira metade crescente e segunda decrescente
